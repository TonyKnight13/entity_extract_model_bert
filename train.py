...
flags.DEFINE_string("ckpt_path", "law_ckpt", "Path to save model")
flags.DEFINE_string("summary_path", "summary", "Path to store summaries")
flags.DEFINE_string("log_file", "law_train.log", "File for log")
flags.DEFINE_string("map_file", "law.pkl", "file for maps")
flags.DEFINE_string("vocab_file", "vocab.json", "File for vocab")
flags.DEFINE_string("config_file", "config_file", "File for config")
flags.DEFINE_string("script", "conlleval", "evaluation script")
flags.DEFINE_string("result_path", "result3", "Path for results")
flags.DEFINE_string("train_file", os.path.join("data", "law/train.txt"), "Path for train data")
flags.DEFINE_string("dev_file", os.path.join("data", "law/dev.txt"), "Path for dev data")
flags.DEFINE_string("test_file", os.path.join("data", "law/test.txt"), "Path for test data")
